...
SERVICE_CAPS = microbial_interaction_prediction
SPEC_FILE = microbial_interaction_prediction.spec
URL = https://kbase.us/services/microbial_interaction_prediction
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
